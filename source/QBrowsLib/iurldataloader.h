...
#ifndef IURLDATALOADER_H
#define IURLDATALOADER_H

#include <QUrl>

class IUrlDataLoader
	:public QObject
{
	Q_OBJECT
public:
	virtual ~IUrlDataLoader(){}
	virtual bool loadData(QUrl &url,QByteArray *data)=0;

signals:
	void redirect(QUrl &url,QByteArray *data);
};

#endif // IURLDATALOADER_H
